...
public class TestClient {
	...
	public void test() throws NamingException {
		 ...
		 Object o = context.
		   lookup("java:global/HelloApplication/HelloEJB/SayHello!beans.SayHelloRemote");
		 SayHelloRemote sh_rem = (SayHelloRemote) o;   
		 assertEquals("HelloWorld", sh_rem.hello("World"));
		 
		 o = context.
		   lookup("java:global/HelloApplication/HelloEJB/Counter!beans.CounterRemote");
